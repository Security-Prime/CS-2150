...
/** @brief a Constructor for Middle-Earth
 *
 * Iluvatar, the creator of Middle-Earth
 * counts the num of cities & find out the distance between them & ceate random city locations
 *
 * @param xsize size of x axis of Middle-Earth
 * @param ysize size of y axis of Middle-Earth
...
/** @brief prints cities of the MiddleEarth
 *
 * The mouth of Sauron
 */
...
/** @brief prints a table of distances between cities
 *
 */
...
/** @brief distance between two desired cities
 *
 * Compute and returns the distance between two cities 
 * 
...
/** @brief returns list of cities to travel to
 *
 * Returns a vector of city names to travel to.  The first city is the original start point
 * as well as the end point. The number of cities passed in does not include this start/end
 * point (so there will be length+1 entries in the returned vector).
