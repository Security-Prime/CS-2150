...
mergeSort:
	...
	; Implement mergeSort here
        ...
        xor 	rax, rax        ;  result                        
       	add	rax,rsi
	add	rax,rdx		;start + end	
	sar     rax,1           ;devide by 2 
	mov	rcx,rax		;move mid to rcx	;devide by 2
	cmp     rsi, rdx      ; if start less than end
	jge	xit
	
	push    rsi
	push    rdx

	mov	rdx,rcx		;move mid to end for the first call
	call    mergeSort       ;jump into recursion
	...
	dec     rcx
	mov	r12,rdx		;move end to a temp	
	mov     rdx,rcx		;move mid to second parameter
	mov	rcx,r12		;move end to third parameter
	push     r10
	push     r11
