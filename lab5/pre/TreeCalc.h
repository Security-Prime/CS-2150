// Farid Rajabi Nia fr2md 02/25/2018 TreeCalc.h
...
#include <stack> // include your stack implementation here
...
private:
    ...
    bool StringToInt(const string &s, int &i); //String to int function
